function CtaSection() {
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-10">
      <div className="relative mx-auto max-w-4xl overflow-hidden rounded-[2.5rem] bg-primary-container p-10 text-center md:p-14">
        ...
        <h2 className="mb-5 font-headline text-3xl font-bold tracking-tight text-on-primary-container md:text-4xl">
          Ready to begin your journey?
        </h2>
        <p className="mx-auto mb-8 max-w-2xl text-base text-primary-fixed opacity-90 md:text-lg">
